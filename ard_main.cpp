...
class ard_main 
{
    ...
    // constants to switch motor direction
    // only +1 or -1
    ...
    NewPing(46, 48, MAX_DISTANCE), // trigger pin, echo pin, and max distance to ping. 
    ...
    // PIXY
    Pixy2 pixy; // initialize Pixy object
    ...
    void ard_main::receiveData(int byte_count)
    {
    ...
    void ard_main::setMotors(int p_m1,int p_m2,int p_m3,int p_m4) 
    {
    ...
    void ard_main::setSolenoid(bool solState)
    {
        if (solState == 1) 
        {
